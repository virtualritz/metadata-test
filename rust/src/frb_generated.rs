...
fn wire__crate__api__file_info__FileInfo_new_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        4 => wire__crate__api__init__init_app_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        3 => wire__crate__api__file_info__FileInfo_new_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        5 => wire__crate__api__metadata__Metadata_accessed_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        6 => wire__crate__api__metadata__Metadata_author_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        7 => wire__crate__api__metadata__Metadata_format_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        8 => wire__crate__api__metadata__Metadata_modified_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        9 => wire__crate__api__metadata__Metadata_specific_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        10 => wire__crate__api__metadata__Metadata_title_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
