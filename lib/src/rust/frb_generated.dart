...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1130875105;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<DateTime> crateApiMetadataMetadataAccessed({required Metadata that});

  Future<String?> crateApiMetadataMetadataAuthor({required Metadata that});

  Future<FileFormat> crateApiMetadataMetadataFormat({required Metadata that});

  Future<DateTime> crateApiMetadataMetadataModified({required Metadata that});

  Future<SpecificMetadata?> crateApiMetadataMetadataSpecific(
      {required Metadata that});

  Future<String?> crateApiMetadataMetadataTitle({required Metadata that});
...
class MetadataImpl extends RustOpaque implements Metadata {
  ...
  Future<DateTime> accessed() =>
      RustLib.instance.api.crateApiMetadataMetadataAccessed(
        that: this,
      );

  Future<String?> author() =>
      RustLib.instance.api.crateApiMetadataMetadataAuthor(
        that: this,
      );

  Future<FileFormat> format() =>
      RustLib.instance.api.crateApiMetadataMetadataFormat(
        that: this,
      );

  Future<DateTime> modified() =>
      RustLib.instance.api.crateApiMetadataMetadataModified(
        that: this,
      );
  ...
  Future<String?> title() => RustLib.instance.api.crateApiMetadataMetadataTitle(
        that: this,
      );
}
